              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <div className="bg-gray-100 rounded-lg p-4">
                    <p className="text-gray-800 text-base">Hello! How can I help you today?</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-100 p-5">
              <div className="flex space-x-3">
                <input
                  ...
                  className="flex-1 rounded-lg border border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-900 placeholder-gray-500 text-base"
                />
                <button className="bg-indigo-600 text-white px-5 py-3 rounded-lg hover:bg-indigo-700 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
